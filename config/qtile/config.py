...
keys = [
    ...
    Key([mod],"l",lazy.spawn("dm-tool lock"),desc="Locks Screen")
]
...
layouts = [
    layout.Columns(border_focus_stack=["#000000", "#000000"], border_width=2,border_normal="#000000",border_focus="#000000"),
    #layout.Max(),
