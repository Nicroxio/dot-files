    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Systray(),
                widget.TextBox(text='',fontsize=35, padding=0,foreground='cc6666'),
                widget.OpenWeather(location='Halifax,GB',foreground='#000000', background='#cc6666', padding=0),
                widget.TextBox(text='',fontsize=35, padding=0,foreground='#e6c547',background='#cc6666'),
                widget.Battery(background='#e6c547',foreground='#000000',padding=5),
                widget.TextBox(text='',fontsize=35, padding=0,foreground='#b5bd68',background='#e6c547'),
                widget.Memory(background='#b5bd68',foreground='#000000',padding=5),
                widget.TextBox(text='',fontsize=35, padding=0,foreground='#70c0ba',background='#b5bd68'),
