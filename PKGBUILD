...
license=('GPL')
depends=("alacritty" "qtile" "xorg" "dmenu" "firefox" "python-pip" " python" "picom" "nitrogen" "alsa" "pulseaudio" "lightdm-slick-greeter" "lightdm" "nvim" "keepassxc" "thunar" "restic" "terminus-font-ttf" "networkmanager" "flameshot" "code" "git" "python-psutil")
makedepends=()
